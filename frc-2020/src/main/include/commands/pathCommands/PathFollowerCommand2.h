...
class PathFollowerCommand2 : public frc2::CommandHelper<frc2::CommandBase, PathFollowerCommand2> {
 private:
  ...
  bool m_stopAtEnd;
 public:
  PathFollowerCommand2(DriveSubsystem* driveTrain,
                      SwerveDrivePathFollower* follower, const std::string &name,
                      bool zero = false,
                      bool stopAtEnd = true){
