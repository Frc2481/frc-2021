...
class LimelightUpdatePose
 ...
 public:
  ...
  void Initialize() override{
    ...
    frc::SmartDashboard::PutNumber("Lime light X", distanceX*39.37);
    frc::SmartDashboard::PutNumber("Lime light Y", distanceY*39.37);
    frc::SmartDashboard::PutNumber("Lime light theata", ty*180/MATH_CONSTANTS_PI);
    frc::SmartDashboard::PutNumber("Lime light yaw", headingToTarget*180/MATH_CONSTANTS_PI);
