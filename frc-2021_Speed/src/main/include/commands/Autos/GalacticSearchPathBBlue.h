...
class GalacticSearchPathBBlue
 ...
 public:
  GalacticSearchPathBBlue(DriveSubsystem* m_drive,
    ...
    path.push_back(SwerveDrivePathGenerator::waypoint_t {43.5, 60, 0, 0, 0});//start path
    path.push_back(SwerveDrivePathGenerator::waypoint_t {180, 60, 0, RobotParameters::k_maxSpeed*metersToInches, 0});//pick up ball 1
