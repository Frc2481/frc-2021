...
class TalonSRXMotorController : public CommonMotorController {
 
 public:
  TalonSRXMotorController(int motorID, const std::string &name);
  ...
  void  config_PID(const TalonSRXPIDSetConfiguration& pid, int pidIdx = 0, int timeoutMs = 50);
